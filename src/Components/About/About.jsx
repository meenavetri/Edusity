    ...
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>Embark on a transformative educational journey with our
                ...
                skills,and experiences needed to excel in the dynamic fiels of education.
            </p>
            <p>
            ...
            <p>Whether you aspire to become a teacher, administrator, counselor, or educational leader, our
                diverse range of programs offers the perfect pathway to achive your goals and unlock your full
